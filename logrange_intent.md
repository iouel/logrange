...
Three of six are closed (1, 2, 5). Three remain: shape coverage, a stated bound on the emitted state, and the dead original chain. The posture is unchanged — it was decided on 5 HIGH findings in 2859 loops, and closing conditions does not move that number.
